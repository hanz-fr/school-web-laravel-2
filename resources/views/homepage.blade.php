...
@section('container')
    ...
    <div class="position-relative overflow-hidden p-md-5 m-md-3 text-center"
        style="background: url('{{ asset('storage/images/D2iyz10UgAUc7bv.jpg') }}'); background-size: 100% 100%; height: 45vmax; background-repeat: no-repeat; border-radius: 10px; margin-top: 10px"
        ...
        <div class="col-md-5 mx-auto position-relative" style="margin-top: 15%" data-aos="fade-up" data-aos-duration="1100">
            ...
            <p class="lead fw-normal fs-3 sm-fs-5 text-white" style="z-index: 10">Informasi PPDB dan Penerimaan Siswa terbaru
                silahkan klik link dibawah ini. Ayo, daftar segera!</p>
    ...
    <div class="container col-xxl-8 px-4" data-aos="fade-left" data-aos-duration="1500" data-aos-once="true">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5" style="margin-top: 8rem;">
            ...
            <div class="col-10 col-sm-8 col-lg-6">
                <img src="{{ asset('storage/images/school-3.jpg') }}" class="d-block mx-lg-auto img-fluid shadow-lg"
                    alt="img" width="500" height="500" loading="lazy">
            </div>
            <div class="col-lg-6">
                <h1 class="display-5 fw-bold lh-1 mb-3">Mengenal lebih dekat</h1>
                <p class="lead">SMPN 7 Cimahi adalah Sekolah Menengah Pertama yang berdomisili di Cimahi, tepatnya
                    di Jalan Kebon Jeruk RT 001 RW 020,
                    Cibeureum, Kecamatan Cimahi Selatan, Kota Cimahi Provinsi Jawa Barat.<br>SMPN 7 Cimahi menggunakan
                    Kurikulum 2013 dengan menerapkan manajemen berbasis sekolah.</p>
    ...
    <div class="container px-4 marketing" style="margin-top: 10em">
        <div class="row featurette">
            <div class="col-md-7 order-md-2" data-aos="fade-down" data-aos-duration="1200" data-aos-once="true">
                <h2 class="featurette-heading">SMPN 7 Cimahi <span class="text-muted">menyediakan fasilitas yang
                        baik.</span></h2>
                <p class="lead">
                    Guna menunjang semua kebutuhan pendidikan bagi siswa dan siswi, SMPN 7 Cimahi telah menyediakan
                    fasilitas belajar yang cukup untuk melaksanakan pembelajaran KBM.
                    <br>Salah satu nya adalah koneksi internet fiber optic yang biasa dimanfaatkan untuk Ujian berbasis
                    online atau daring.
                </p>
            </div>
            <div class="col-md-5 order-md-1" data-aos="fade-left" data-aos-duration="1500" data-aos-once="true">
                <img src="{{ asset('storage/images/school-2.jpg') }}" class="d-block mx-lg-auto img-fluid shadow-lg"
    ...
    <div class="container-fluid text-center" style="margin-top: 15em; margin-bottom: 5em">
        <div class="numbers d-flex flex-md-row flex-wrap justify-content-center" data-aos="fade-up" data-aos-duration="1000"
            data-aos-once="true">
            <div class="rect">
                <h1>45</h1>
                <p>Guru</p>
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true"
        style="margin-top: 15em; margin-bottom: 10em">
        <a class="list-group-item list-group-item-action d-flex gap-3 py-5" aria-current="true">
            <div class="d-flex gap-2 w-100 justify-content-between px-3">
                <h6 class="mb-0">Rasio Siswa Rombel</h6>
                <small class="opacity-50 text-nowrap">38</small>
            </div>
        </a>

        <a class="list-group-item list-group-item-action d-flex gap-3 py-5" aria-current="true">
            <div class="d-flex gap-2 w-100 justify-content-between px-3">
                <h6 class="mb-0">Rasio Siswa Guru</h6>
                <small class="opacity-50 text-nowrap">22.8</small>
            </div>
        </a>

        <a class="list-group-item list-group-item-action d-flex gap-3 py-5" aria-current="true">
            <div class="d-flex gap-2 w-100 justify-content-between px-3">
                <h6 class="mb-0">Persentase Guru Kualifikasi</h6>
                <small class="opacity-50 text-nowrap">95.56</small>
            </div>
        </a>

        <a class="list-group-item list-group-item-action d-flex gap-3 py-5" aria-current="true">
            <div class="d-flex gap-2 w-100 justify-content-between px-3">
                <h6 class="mb-0">Persentase Guru Sertifikasi</h6>
                <small class="opacity-50 text-nowrap">77.78</small>
            </div>
        </a>

        <a class="list-group-item list-group-item-action d-flex gap-3 py-5" aria-current="true">
            <div class="d-flex gap-2 w-100 justify-content-between px-3">
                <h6 class="mb-0">Persentase Guru PNS </h6>
        ...
        <a class="list-group-item list-group-item-action d-flex gap-3 py-5" aria-current="true">
            <div class="d-flex gap-2 w-100 justify-content-between px-3">
                <h6 class="mb-0">Persentase Ruang Kelas Layak</h6>
    ...
    {{-- JUMBOTRON --}}
    <div class="p-5 mt-5" style="background-color: #37535C" data-aos="fade-right" data-aos-duration="800"
        data-aos-once="true">
        <div class="container py-5">
            <h1 class="display-5 fw-bold text-white">Daftar sekarang!</h1>
            <p class="col-md-8 fs-4 text-white">Jadi murid yang unggul dalam pendidikan dan berkarakter bersama kami. Kuota
                terbatas!</p>
